...
# ---------------------------------------------------------------------------
# Slide narration scripts — KITT-style delivery
# ---------------------------------------------------------------------------

SLIDE_NARRATIONS = {
    1: (
        "Welcome, everyone. I'm here to walk you through The Agentic Crew. "
    ...
    12: (
        ...
        "Then you spin up another one. They don't remember the last session. "
...
def main():
    ...
    for slide_num in sorted(SLIDE_NARRATIONS.keys()):
        ...
        mp3_path = OUTPUT_DIR / f"slide-{slide_num:02d}-female.mp3"
        ...
        try:
            ...
            if HAS_FFMPEG:
                ...
                wav_path = OUTPUT_DIR / f"slide-{slide_num:02d}-female.wav"
    ...
    print("\nDone! Female audio files are in:", OUTPUT_DIR)
