...
// DEPRECATED — replaced by OS-specific editions:
//   book-hands-on-windows.typ
//   book-hands-on-mac.typ
//   book-hands-on-linux.typ
// This file is kept for reference. Use the OS-specific versions instead.
