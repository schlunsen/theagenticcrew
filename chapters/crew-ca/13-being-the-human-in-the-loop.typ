...
#figure(
  ...
  caption: [_Tu ets el control de qualitat._],
)
...
Coneixement del sector, gust, criteri, relacions, empatia, context, política, timing — aquestes no són funcionalitats que puguis afegir a un model de llenguatge. Són les coses que fan que la feina _funcioni_. Són el que tu aportes.
...
*Per a tasques llargues (dies):* L'agent treballa en branques, i tu revises pull requests. Aquest és el flux de treball de Git del Capítol 3. L'agent proposa canvis, tu revises els canvis, i tu decideixes què es fusiona. Si alguna cosa està malament, ho rebutges i proporciones millors instruccions.
...
Quan revises el resultat de l'agent, no estàs comprovant si el codi compila o si la gramàtica és correcta. D'això se n'encarrega l'agent. Estàs comprovant coses que l'agent _no pot_ comprovar:
...
Per això algú com en Morten, l'instal·lador de finestres, va poder construir una aplicació de pressupostos d'aspecte professional en un cap de setmana. Ha passat quinze anys desenvolupant _gust_ per com ha de ser un bon pressupost, quina informació necessita un client, com ha de ser una interacció professional. No sabia escriure el codi. Però sabia reconèixer si el resultat era correcte — i reconduir-lo fins que ho fos.
...
Ser l'humà en el procés no és un paper temporal fins que els agents millorin. És el paper _permanent_. Les tasques concretes canviaran. Les eines milloraran. Però la necessitat de criteri humà, gust humà i responsabilitat humana no anirà enlloc.

La pregunta no és si estaràs en el procés. És si en seràs _bo_. I ser-ne bo significa desenvolupar exactament les habilitats que aquest llibre ensenya: comunicació clara, escepticisme sa, experiència en el teu àmbit, i la confiança per anul·lar una màquina quan el teu criteri diu el contrari.
