// La Tripulación Agéntica — Guía Práctica (Edición macOS)
// Ejercicios prácticos para aprender haciendo
// Compila todos los capítulos en un solo PDF — instrucciones específicas para macOS
...
#set document(
  title: "La Tripulación Agéntica: Guía Práctica — Edición macOS",
...
#page(margin: 0pt, header: none)[
  ...
  #block(width: 100%, height: 100%, fill: black)[
    ...
    // ── Subtítulo ──
    #place(dx: 8%, dy: 76%)[
      #text(size: 11pt, fill: cream, style: "italic")[Guía Práctica — Edición macOS]
    ]
