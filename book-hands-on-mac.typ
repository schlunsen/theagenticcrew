// The Agentic Crew — Hands-On Guide (macOS Edition)
// Practical exercises for learning by doing
// Compiles all chapters into a single PDF — macOS-specific instructions only
...
#set document(
  title: "The Agentic Crew: Hands-On Guide — macOS Edition",
...
#page(margin: 0pt, header: none)[
  ...
  #block(width: 100%, height: 100%, fill: black)[
    ...
    #place(dx: 8%, dy: 76%)[
      #text(size: 11pt, fill: cream, style: "italic")[Hands-On Guide — macOS Edition]
    ]
...
Each chapter is an exercise. You'll set up real tools, work with real repositories, and build real things — starting from scratch. The exercises are written for macOS.
