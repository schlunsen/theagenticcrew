// La Tripulación Agéntica — Guía Práctica (Edición Linux)
// Ejercicios prácticos para aprender haciendo
// Compila todos los capítulos en un solo PDF — instrucciones específicas para Linux
...
#set document(
  title: "La Tripulación Agéntica: Guía Práctica — Edición Linux",
...
Cada capítulo es un ejercicio. Configurarás herramientas reales, trabajarás con repositorios reales y construirás cosas reales, empezando desde cero. Los ejercicios están escritos para Linux (ejemplos basados en Ubuntu — adáptalos a tu distribución).
