// The Agentic Crew — Hands-On Guide (Windows Edition)
// Practical exercises for learning by doing
// Compiles all chapters into a single PDF — Windows-specific instructions only
...
#set document(
  title: "The Agentic Crew: Hands-On Guide — Windows Edition",
...
#page(margin: 0pt, header: none)[
  ...
  #block(width: 100%, height: 100%, fill: black)[
    ...
    #place(dx: 8%, dy: 76%)[
      #text(size: 11pt, fill: cream, style: "italic")[Hands-On Guide — Windows Edition]
    ]
...
Each chapter is an exercise. You'll set up real tools, work with real repositories, and build real things — starting from scratch. The exercises are written for Windows.
